...
class MinioWrapper:
    ...
    def __init__(self, cfg: MinioSettings):
        ...
        params: dict[str, Any] = {"endpoint": self.cfg.host, "secure": self.cfg.certificate_verification}
    ...
    def auth(self) -> bool:
        ...
        try:
            self._client.bucket_exists(self.cfg.bucket_name)  # ty: ignore[unresolved-attribute] self._client may be None, let AttributeError get caught below
        except S3Error as e:
            logger.error(
    ...
    def exists(self) -> bool:
        ...
        try:
            return self._client.bucket_exists(self.cfg.bucket_name)  # ty: ignore[unresolved-attribute] self._client may be None, let AttributeError get caught below
        except Exception as e:
    ...
    def upload_data_to_blob(self, data: bytes):
        ...
        try:
            self._client.put_object(self.cfg.bucket_name, self.cfg.test_blob, io.BytesIO(data), len(data))  # ty: ignore[unresolved-attribute] self._client may be None, let AttributeError get caught below
        except Exception as e:
    ...
    def download_blob_and_verify_data(self, data: bytes) -> bool:
        ...
        try:
            response = self._client.get_object(self.cfg.bucket_name, self.cfg.test_blob)  # ty: ignore[unresolved-attribute] self._client may be None, let AttributeError get caught below
    ...
    def _check_blob_exists(self) -> bool:
        ...
        try:
            self._client.stat_object(self.cfg.bucket_name, self.cfg.test_blob)  # ty: ignore[unresolved-attribute] self._client may be None, let AttributeError get caught below
        except S3Error:
            return False
        return True
    ...
    def delete_blob(self) -> bool:
        ...
        try:
            if self._check_blob_exists():
                self._client.remove_object(self.cfg.bucket_name, self.cfg.test_blob)  # ty: ignore[unresolved-attribute] self._client may be None, let AttributeError get caught below
            return True
        except Exception as e:
